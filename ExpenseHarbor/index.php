...
<body>
    <div class="container">
        ...
        <form action="index.php" method="post" onsubmit = "return validate()" id="form1">
            ...
            <span style="color: rgba(255, 0, 0, 0.8); font-weight: bolder; font-family: 'Source Sans Pro';">
            Forgot Password ?
            </span>
            </a>
            </div>
        ...
        <div class="img-container">
            <img src="static/images/loginpc.png" alt="Login-screen-picture">
        </div>
    </div>
